...
class Primerize_3D(object):
    def __init__(self, offset=0, N_mutations=1, which_lib=1, is_single=True, COL_SIZE=142, prefix='lib'):
        self.prefix = prefix
        self.offset = offset
    ...
    def design(self, sequence, primer_set=[], offset=None, structures=[], N_mutations=None, which_lib=None, which_muts=[], prefix=None, is_single=None, is_force=False):
